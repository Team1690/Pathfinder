...
class RobotAction extends $pb.GeneratedMessage {
  ...
  RobotAction._() : super();
  factory RobotAction.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RobotAction.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RobotAction',
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  RobotAction copyWith(void Function(RobotAction) updates) =>
      super.copyWith((message) => updates(message as RobotAction))
          as RobotAction;
  ...
  @$core.pragma('dart2js:noInline')
  static RobotAction getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RobotAction>(create);
...
class Point extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOM<Vector>(1, _omitFieldNames ? '' : 'position',
        subBuilder: Vector.create)
    ..aOM<Vector>(2, _omitFieldNames ? '' : 'controlIn',
        protoName: 'controlIn', subBuilder: Vector.create)
    ..aOM<Vector>(3, _omitFieldNames ? '' : 'controlOut',
        protoName: 'controlOut', subBuilder: Vector.create)
    ..aOB(4, _omitFieldNames ? '' : 'useHeading', protoName: 'useHeading')
    ..a<$core.double>(5, _omitFieldNames ? '' : 'heading', $pb.PbFieldType.OF)
    ..aOM<RobotAction>(6, _omitFieldNames ? '' : 'action',
        subBuilder: RobotAction.create)
    ..hasRequiredFields = false;
...
class Segment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.double>(
        2, _omitFieldNames ? '' : 'maxVelocity', $pb.PbFieldType.OF,
        protoName: 'maxVelocity')
    ..e<SplineTypes>(3, _omitFieldNames ? '' : 'splineType', $pb.PbFieldType.OE,
        protoName: 'splineType',
        defaultOrMaker: SplineTypes.None,
        valueOf: SplineTypes.valueOf,
        enumValues: SplineTypes.values)
    ..aOM<SplineParameters>(4, _omitFieldNames ? '' : 'splineParameters',
        protoName: 'splineParameters', subBuilder: SplineParameters.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  set splineParameters(SplineParameters v) {
    setField(4, v);
  }
...
class Section extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..pc<Segment>(1, _omitFieldNames ? '' : 'segments', $pb.PbFieldType.PM,
...
class SplineParameters extends $pb.GeneratedMessage {
  ...
  factory SplineParameters.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SplineParameters.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SplineParameters',
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SplineParameters copyWith(void Function(SplineParameters) updates) =>
      super.copyWith((message) => updates(message as SplineParameters))
          as SplineParameters;
  ...
  static $pb.PbList<SplineParameters> createRepeated() =>
      $pb.PbList<SplineParameters>();
  @$core.pragma('dart2js:noInline')
  static SplineParameters getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SplineParameters>(create);
...
class SplineRequest_OptimizationParams_Hermite extends $pb.GeneratedMessage {
  ...
  factory SplineRequest_OptimizationParams_Hermite.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SplineRequest_OptimizationParams_Hermite.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SplineRequest.OptimizationParams.Hermite',
      createEmptyInstance: create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SplineRequest_OptimizationParams_Hermite clone() =>
      SplineRequest_OptimizationParams_Hermite()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SplineRequest_OptimizationParams_Hermite copyWith(
          void Function(SplineRequest_OptimizationParams_Hermite) updates) =>
      super.copyWith((message) =>
              updates(message as SplineRequest_OptimizationParams_Hermite))
          as SplineRequest_OptimizationParams_Hermite;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SplineRequest_OptimizationParams_Hermite create() =>
      SplineRequest_OptimizationParams_Hermite._();
  SplineRequest_OptimizationParams_Hermite createEmptyInstance() => create();
  static $pb.PbList<SplineRequest_OptimizationParams_Hermite>
      createRepeated() =>
          $pb.PbList<SplineRequest_OptimizationParams_Hermite>();
  @$core.pragma('dart2js:noInline')
  static SplineRequest_OptimizationParams_Hermite getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          SplineRequest_OptimizationParams_Hermite>(create);
...
class SplineRequest_OptimizationParams_Bezier extends $pb.GeneratedMessage {
  ...
  factory SplineRequest_OptimizationParams_Bezier.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SplineRequest_OptimizationParams_Bezier.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SplineRequest.OptimizationParams.Bezier',
      createEmptyInstance: create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SplineRequest_OptimizationParams_Bezier clone() =>
      SplineRequest_OptimizationParams_Bezier()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SplineRequest_OptimizationParams_Bezier copyWith(
          void Function(SplineRequest_OptimizationParams_Bezier) updates) =>
      super.copyWith((message) =>
              updates(message as SplineRequest_OptimizationParams_Bezier))
          as SplineRequest_OptimizationParams_Bezier;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SplineRequest_OptimizationParams_Bezier create() =>
      SplineRequest_OptimizationParams_Bezier._();
  SplineRequest_OptimizationParams_Bezier createEmptyInstance() => create();
  static $pb.PbList<SplineRequest_OptimizationParams_Bezier> createRepeated() =>
      $pb.PbList<SplineRequest_OptimizationParams_Bezier>();
  @$core.pragma('dart2js:noInline')
  static SplineRequest_OptimizationParams_Bezier getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          SplineRequest_OptimizationParams_Bezier>(create);
...
class SplineRequest_OptimizationParams_Polynomial extends $pb.GeneratedMessage {
  ...
  factory SplineRequest_OptimizationParams_Polynomial.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SplineRequest_OptimizationParams_Polynomial.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SplineRequest.OptimizationParams.Polynomial',
      createEmptyInstance: create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SplineRequest_OptimizationParams_Polynomial clone() =>
      SplineRequest_OptimizationParams_Polynomial()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SplineRequest_OptimizationParams_Polynomial copyWith(
          void Function(SplineRequest_OptimizationParams_Polynomial) updates) =>
      super.copyWith((message) =>
              updates(message as SplineRequest_OptimizationParams_Polynomial))
          as SplineRequest_OptimizationParams_Polynomial;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SplineRequest_OptimizationParams_Polynomial create() =>
      SplineRequest_OptimizationParams_Polynomial._();
  SplineRequest_OptimizationParams_Polynomial createEmptyInstance() => create();
  static $pb.PbList<SplineRequest_OptimizationParams_Polynomial>
      createRepeated() =>
          $pb.PbList<SplineRequest_OptimizationParams_Polynomial>();
  @$core.pragma('dart2js:noInline')
  static SplineRequest_OptimizationParams_Polynomial getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          SplineRequest_OptimizationParams_Polynomial>(create);
...
class SplineRequest_OptimizationParams extends $pb.GeneratedMessage {
  ...
  factory SplineRequest_OptimizationParams.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SplineRequest_OptimizationParams.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SplineRequest.OptimizationParams',
      createEmptyInstance: create)
    ..aOM<SplineRequest_OptimizationParams_Hermite>(
        5, _omitFieldNames ? '' : 'hermite',
        subBuilder: SplineRequest_OptimizationParams_Hermite.create)
    ..aOM<SplineRequest_OptimizationParams_Bezier>(
        6, _omitFieldNames ? '' : 'bezier',
        subBuilder: SplineRequest_OptimizationParams_Bezier.create)
    ..aOM<SplineRequest_OptimizationParams_Polynomial>(
        7, _omitFieldNames ? '' : 'polynomial',
        subBuilder: SplineRequest_OptimizationParams_Polynomial.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SplineRequest_OptimizationParams clone() =>
      SplineRequest_OptimizationParams()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SplineRequest_OptimizationParams copyWith(
          void Function(SplineRequest_OptimizationParams) updates) =>
      super.copyWith(
              (message) => updates(message as SplineRequest_OptimizationParams))
          as SplineRequest_OptimizationParams;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SplineRequest_OptimizationParams create() =>
      SplineRequest_OptimizationParams._();
  SplineRequest_OptimizationParams createEmptyInstance() => create();
  static $pb.PbList<SplineRequest_OptimizationParams> createRepeated() =>
      $pb.PbList<SplineRequest_OptimizationParams>();
  @$core.pragma('dart2js:noInline')
  static SplineRequest_OptimizationParams getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SplineRequest_OptimizationParams>(
          create);
  ...
  @$pb.TagNumber(5)
  set hermite(SplineRequest_OptimizationParams_Hermite v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(6)
  set bezier(SplineRequest_OptimizationParams_Bezier v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(7)
  set polynomial(SplineRequest_OptimizationParams_Polynomial v) {
    setField(7, v);
  }
...
class SplineRequest extends $pb.GeneratedMessage {
  ...
  factory SplineRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SplineRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SplineRequest',
      createEmptyInstance: create)
    ..pc<Segment>(1, _omitFieldNames ? '' : 'segments', $pb.PbFieldType.PM,
        subBuilder: Segment.create)
    ..aOM<SplineParameters>(2, _omitFieldNames ? '' : 'splineParameters',
        protoName: 'splineParameters', subBuilder: SplineParameters.create)
    ..a<$core.double>(
        3, _omitFieldNames ? '' : 'evaluatedPointsInterval', $pb.PbFieldType.OF,
        protoName: 'evaluatedPointsInterval')
    ..aOM<SplineRequest_OptimizationParams>(
        4, _omitFieldNames ? '' : 'optimizationParams',
        protoName: 'optimizationParams',
        subBuilder: SplineRequest_OptimizationParams.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SplineRequest copyWith(void Function(SplineRequest) updates) =>
      super.copyWith((message) => updates(message as SplineRequest))
          as SplineRequest;
  ...
  static $pb.PbList<SplineRequest> createRepeated() =>
      $pb.PbList<SplineRequest>();
  @$core.pragma('dart2js:noInline')
  static SplineRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SplineRequest>(create);
  ...
  @$pb.TagNumber(3)
  set evaluatedPointsInterval($core.double v) {
    $_setFloat(2, v);
  }
  ...
  @$pb.TagNumber(4)
  set optimizationParams(SplineRequest_OptimizationParams v) {
    setField(4, v);
  }
...
class SplineResponse_Point extends $pb.GeneratedMessage {
  ...
  factory SplineResponse_Point.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SplineResponse_Point.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SplineResponse.Point',
      createEmptyInstance: create)
    ..aOM<Vector>(1, _omitFieldNames ? '' : 'point', subBuilder: Vector.create)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'segmentIndex', $pb.PbFieldType.O3,
        protoName: 'segmentIndex')
    ..hasRequiredFields = false;

  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SplineResponse_Point clone() =>
      SplineResponse_Point()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SplineResponse_Point copyWith(void Function(SplineResponse_Point) updates) =>
      super.copyWith((message) => updates(message as SplineResponse_Point))
          as SplineResponse_Point;
  ...
  static $pb.PbList<SplineResponse_Point> createRepeated() =>
      $pb.PbList<SplineResponse_Point>();
  @$core.pragma('dart2js:noInline')
  static SplineResponse_Point getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SplineResponse_Point>(create);
...
class SplineResponse extends $pb.GeneratedMessage {
  ...
  factory SplineResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SplineResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SplineResponse',
      createEmptyInstance: create)
    ..aOM<SplineParameters>(1, _omitFieldNames ? '' : 'splineParameters',
        protoName: 'splineParameters', subBuilder: SplineParameters.create)
    ..e<SplineTypes>(2, _omitFieldNames ? '' : 'splineType', $pb.PbFieldType.OE,
        protoName: 'splineType',
        defaultOrMaker: SplineTypes.None,
        valueOf: SplineTypes.valueOf,
        enumValues: SplineTypes.values)
    ..pc<SplineResponse_Point>(
        3, _omitFieldNames ? '' : 'evaluatedPoints', $pb.PbFieldType.PM,
        protoName: 'evaluatedPoints', subBuilder: SplineResponse_Point.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SplineResponse copyWith(void Function(SplineResponse) updates) =>
      super.copyWith((message) => updates(message as SplineResponse))
          as SplineResponse;
  ...
  static $pb.PbList<SplineResponse> createRepeated() =>
      $pb.PbList<SplineResponse>();
  @$core.pragma('dart2js:noInline')
  static SplineResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SplineResponse>(create);
...
class TrajectoryRequest_SwerveRobotParams extends $pb.GeneratedMessage {
  ...
  factory TrajectoryRequest_SwerveRobotParams.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TrajectoryRequest_SwerveRobotParams.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TrajectoryRequest.SwerveRobotParams',
      createEmptyInstance: create)
    ..a<$core.double>(1, _omitFieldNames ? '' : 'width', $pb.PbFieldType.OF)
    ..a<$core.double>(2, _omitFieldNames ? '' : 'height', $pb.PbFieldType.OF)
    ..a<$core.double>(
        3, _omitFieldNames ? '' : 'maxVelocity', $pb.PbFieldType.OF,
        protoName: 'maxVelocity')
    ..a<$core.double>(
        4, _omitFieldNames ? '' : 'maxAcceleration', $pb.PbFieldType.OF,
        protoName: 'maxAcceleration')
    ..a<$core.double>(
        5, _omitFieldNames ? '' : 'skidAcceleration', $pb.PbFieldType.OF,
        protoName: 'skidAcceleration')
    ..a<$core.double>(6, _omitFieldNames ? '' : 'maxJerk', $pb.PbFieldType.OF,
        protoName: 'maxJerk')
    ..a<$core.double>(7, _omitFieldNames ? '' : 'cycleTime', $pb.PbFieldType.OF,
        protoName: 'cycleTime')
    ..a<$core.double>(8, _omitFieldNames ? '' : 'angularAccelerationPercentage',
        $pb.PbFieldType.OF,
        protoName: 'angularAccelerationPercentage')
    ..hasRequiredFields = false;

  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  TrajectoryRequest_SwerveRobotParams clone() =>
      TrajectoryRequest_SwerveRobotParams()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TrajectoryRequest_SwerveRobotParams copyWith(
          void Function(TrajectoryRequest_SwerveRobotParams) updates) =>
      super.copyWith((message) =>
              updates(message as TrajectoryRequest_SwerveRobotParams))
          as TrajectoryRequest_SwerveRobotParams;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static TrajectoryRequest_SwerveRobotParams create() =>
      TrajectoryRequest_SwerveRobotParams._();
  TrajectoryRequest_SwerveRobotParams createEmptyInstance() => create();
  static $pb.PbList<TrajectoryRequest_SwerveRobotParams> createRepeated() =>
      $pb.PbList<TrajectoryRequest_SwerveRobotParams>();
  @$core.pragma('dart2js:noInline')
  static TrajectoryRequest_SwerveRobotParams getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          TrajectoryRequest_SwerveRobotParams>(create);
  ...
  @$pb.TagNumber(4)
  set maxAcceleration($core.double v) {
    $_setFloat(3, v);
  }
  ...
  @$pb.TagNumber(5)
  set skidAcceleration($core.double v) {
    $_setFloat(4, v);
  }
  ...
  @$pb.TagNumber(8)
  set angularAccelerationPercentage($core.double v) {
    $_setFloat(7, v);
  }
...
class TrajectoryRequest_TankRobotParams extends $pb.GeneratedMessage {
  ...
  factory TrajectoryRequest_TankRobotParams.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TrajectoryRequest_TankRobotParams.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TrajectoryRequest.TankRobotParams',
      createEmptyInstance: create)
    ..a<$core.double>(1, _omitFieldNames ? '' : 'width', $pb.PbFieldType.OF)
    ..a<$core.double>(2, _omitFieldNames ? '' : 'height', $pb.PbFieldType.OF)
    ..a<$core.double>(
    ...
    ..a<$core.double>(
        4, _omitFieldNames ? '' : 'maxAcceleration', $pb.PbFieldType.OF,
        protoName: 'maxAcceleration')
    ..a<$core.double>(5, _omitFieldNames ? '' : 'maxJerk', $pb.PbFieldType.OF,
        protoName: 'maxJerk')
    ..a<$core.double>(6, _omitFieldNames ? '' : 'cycleTime', $pb.PbFieldType.OF,
        protoName: 'cycleTime')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  TrajectoryRequest_TankRobotParams clone() =>
      TrajectoryRequest_TankRobotParams()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TrajectoryRequest_TankRobotParams copyWith(
          void Function(TrajectoryRequest_TankRobotParams) updates) =>
      super.copyWith((message) =>
              updates(message as TrajectoryRequest_TankRobotParams))
          as TrajectoryRequest_TankRobotParams;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static TrajectoryRequest_TankRobotParams create() =>
      TrajectoryRequest_TankRobotParams._();
  TrajectoryRequest_TankRobotParams createEmptyInstance() => create();
  static $pb.PbList<TrajectoryRequest_TankRobotParams> createRepeated() =>
      $pb.PbList<TrajectoryRequest_TankRobotParams>();
  @$core.pragma('dart2js:noInline')
  static TrajectoryRequest_TankRobotParams getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TrajectoryRequest_TankRobotParams>(
          create);
...
class TrajectoryRequest extends $pb.GeneratedMessage {
  ...
  factory TrajectoryRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TrajectoryRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TrajectoryRequest',
      createEmptyInstance: create)
    ..pc<Section>(1, _omitFieldNames ? '' : 'sections', $pb.PbFieldType.PM,
        subBuilder: Section.create)
    ..e<TrajectoryRequest_DriveTrain>(
        4, _omitFieldNames ? '' : 'driveTrain', $pb.PbFieldType.OE,
        protoName: 'driveTrain',
        defaultOrMaker: TrajectoryRequest_DriveTrain.Swerve,
        valueOf: TrajectoryRequest_DriveTrain.valueOf,
        enumValues: TrajectoryRequest_DriveTrain.values)
    ..aOM<TrajectoryRequest_SwerveRobotParams>(
        5, _omitFieldNames ? '' : 'swerveRobotParams',
        protoName: 'swerveRobotParams',
        subBuilder: TrajectoryRequest_SwerveRobotParams.create)
    ..aOM<TrajectoryRequest_TankRobotParams>(
        6, _omitFieldNames ? '' : 'tankRobotParams',
        protoName: 'tankRobotParams',
        subBuilder: TrajectoryRequest_TankRobotParams.create)
    ..aOS(7, _omitFieldNames ? '' : 'trajectoryFileName',
        protoName: 'trajectoryFileName')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TrajectoryRequest copyWith(void Function(TrajectoryRequest) updates) =>
      super.copyWith((message) => updates(message as TrajectoryRequest))
  ...
  static $pb.PbList<TrajectoryRequest> createRepeated() =>
      $pb.PbList<TrajectoryRequest>();
  @$core.pragma('dart2js:noInline')
  static TrajectoryRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TrajectoryRequest>(create);
  ...
  @$pb.TagNumber(4)
  set driveTrain(TrajectoryRequest_DriveTrain v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(5)
  set swerveRobotParams(TrajectoryRequest_SwerveRobotParams v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(6)
  set tankRobotParams(TrajectoryRequest_TankRobotParams v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(7)
  set trajectoryFileName($core.String v) {
    $_setString(4, v);
  }
...
class TrajectoryResponse_SwervePoint extends $pb.GeneratedMessage {
  ...
  factory TrajectoryResponse_SwervePoint.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TrajectoryResponse_SwervePoint.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TrajectoryResponse.SwervePoint',
      createEmptyInstance: create)
    ..a<$core.double>(1, _omitFieldNames ? '' : 'time', $pb.PbFieldType.OF)
    ..aOM<Vector>(2, _omitFieldNames ? '' : 'position',
        subBuilder: Vector.create)
    ..aOM<Vector>(3, _omitFieldNames ? '' : 'velocity',
        subBuilder: Vector.create)
    ..a<$core.double>(4, _omitFieldNames ? '' : 'heading', $pb.PbFieldType.OF)
    ..a<$core.double>(
        5, _omitFieldNames ? '' : 'angularVelocity', $pb.PbFieldType.OF,
        protoName: 'angularVelocity')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  TrajectoryResponse_SwervePoint clone() =>
      TrajectoryResponse_SwervePoint()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TrajectoryResponse_SwervePoint copyWith(
          void Function(TrajectoryResponse_SwervePoint) updates) =>
      super.copyWith(
              (message) => updates(message as TrajectoryResponse_SwervePoint))
          as TrajectoryResponse_SwervePoint;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static TrajectoryResponse_SwervePoint create() =>
      TrajectoryResponse_SwervePoint._();
  TrajectoryResponse_SwervePoint createEmptyInstance() => create();
  static $pb.PbList<TrajectoryResponse_SwervePoint> createRepeated() =>
      $pb.PbList<TrajectoryResponse_SwervePoint>();
  @$core.pragma('dart2js:noInline')
  static TrajectoryResponse_SwervePoint getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TrajectoryResponse_SwervePoint>(create);
  ...
  @$pb.TagNumber(5)
  set angularVelocity($core.double v) {
    $_setFloat(4, v);
  }
...
class TrajectoryResponse_TankPoint extends $pb.GeneratedMessage {
  ...
  factory TrajectoryResponse_TankPoint.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TrajectoryResponse_TankPoint.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TrajectoryResponse.TankPoint',
      createEmptyInstance: create)
    ..a<$core.double>(1, _omitFieldNames ? '' : 'time', $pb.PbFieldType.OF)
    ..aOM<Vector>(2, _omitFieldNames ? '' : 'position',
        subBuilder: Vector.create)
    ..a<$core.double>(
        3, _omitFieldNames ? '' : 'rightVelocity', $pb.PbFieldType.OF,
        protoName: 'rightVelocity')
    ..a<$core.double>(
        4, _omitFieldNames ? '' : 'leftVelocity', $pb.PbFieldType.OF,
        protoName: 'leftVelocity')
    ..a<$core.double>(5, _omitFieldNames ? '' : 'heading', $pb.PbFieldType.OF)
    ..aOS(6, _omitFieldNames ? '' : 'action')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  TrajectoryResponse_TankPoint clone() =>
      TrajectoryResponse_TankPoint()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TrajectoryResponse_TankPoint copyWith(
          void Function(TrajectoryResponse_TankPoint) updates) =>
      super.copyWith(
              (message) => updates(message as TrajectoryResponse_TankPoint))
          as TrajectoryResponse_TankPoint;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static TrajectoryResponse_TankPoint create() =>
      TrajectoryResponse_TankPoint._();
  TrajectoryResponse_TankPoint createEmptyInstance() => create();
  static $pb.PbList<TrajectoryResponse_TankPoint> createRepeated() =>
      $pb.PbList<TrajectoryResponse_TankPoint>();
  @$core.pragma('dart2js:noInline')
  static TrajectoryResponse_TankPoint getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TrajectoryResponse_TankPoint>(create);
  ...
  @$pb.TagNumber(3)
  set rightVelocity($core.double v) {
    $_setFloat(2, v);
  }
  ...
  @$pb.TagNumber(4)
  set leftVelocity($core.double v) {
    $_setFloat(3, v);
  }
...
class TrajectoryResponse extends $pb.GeneratedMessage {
  ...
  factory TrajectoryResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TrajectoryResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TrajectoryResponse',
      createEmptyInstance: create)
    ..pc<TrajectoryResponse_SwervePoint>(
        1, _omitFieldNames ? '' : 'swervePoints', $pb.PbFieldType.PM,
        protoName: 'swervePoints',
        subBuilder: TrajectoryResponse_SwervePoint.create)
    ..pc<TrajectoryResponse_TankPoint>(
        2, _omitFieldNames ? '' : 'tankPoints', $pb.PbFieldType.PM,
        protoName: 'tankPoints',
        subBuilder: TrajectoryResponse_TankPoint.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TrajectoryResponse copyWith(void Function(TrajectoryResponse) updates) =>
      super.copyWith((message) => updates(message as TrajectoryResponse))
          as TrajectoryResponse;
  ...
  static $pb.PbList<TrajectoryResponse> createRepeated() =>
      $pb.PbList<TrajectoryResponse>();
  @$core.pragma('dart2js:noInline')
  static TrajectoryResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TrajectoryResponse>(create);
